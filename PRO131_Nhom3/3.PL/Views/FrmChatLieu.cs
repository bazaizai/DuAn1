...
namespace _3.PL.Views
{
    public partial class FrmChatLieu : Form
    {
        ...
        private List<ChatLieuViews > _LstSanPham;
        public ChatLieuViews? _SanPham;
        public FrmChatLieu() 
        {
            InitializeComponent();
            _IChatLieuServices = new ChatLieuServices();
            _LstSanPham = new List<ChatLieuViews >();
            tb_Ma.Enabled = false;
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dlg == DialogResult.Yes)
                    {
                        ...
                        _IChatLieuServices.Update(_SanPham);
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dlg == DialogResult.Yes)
                {
                    _IChatLieuServices.Delete(_SanPham);
        ...
        private void dtg_Show_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                _SanPham = _IChatLieuServices.GetChatLieus().FirstOrDefault(x => x.Id == Guid.Parse(r.Cells[0].Value.ToString() ?? "Unknown message id"));
        ...
        public void LoadData()
        {
            ...
            tb_Ma.Enabled = false;
            var lstKhachHang = _IChatLieuServices.GetChatLieus();
            if (tb_TimKiem.Text != "")
            {
        ...
        private string MaTS()
        {
            ...
            int stt = _IChatLieuServices.GetChatLieus().Where(x => Regex.Match(x.Ma, @"^[^0-9]*").Value == tenVT).ToList().Count + 1;
