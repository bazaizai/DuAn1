...
namespace _3.PL.Views
{
    public partial class FrmLichSuTichDiem : Form
    {
        ...
        public void LoadData()
        {
            ...
            dtg_show.Columns[2].Name = "Hệ số tích";          
            ...
            {
                dtg_show.Rows.Add(item.Id, stt++,item.HeSoTich, item.TrangThai == 1 ? "Hoạt động" : "Không hoạt động");
            }
        }
        ...
        {
            _lichSuTichDiemView.HeSoTich = Convert.ToInt32(tb_hesotich.Text);
        ...
        private void dtg_show_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                tb_hesotich.Text =Convert.ToString(_lichSuTichDiemView.HeSoTich);
